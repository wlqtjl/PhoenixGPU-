// Package types — shared domain types for the PhoenixGPU API.
//
// These types form the contract between the API server, pkg/k8s,
// and the WebUI client.  They are intentionally in a public package
// so that both cmd/api-server/internal and pkg/k8s can import them
// without violating Go's internal-package visibility rules.
//
...
// ── FakeK8sClient (for tests and dev mode) ────────────────────────
